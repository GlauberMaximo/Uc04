...
int main() {
    //Declaração e inicialização de uma matriz 3x4 (3filiais, 4 meses)
    ...
    int vendas_filiais[3][4] = {
        ...
        {15000, 14000, 17000} //Vendas da Filial 2 (Meses 1-4)
    };
    ...
    //Exemplo: Calcular o totral de vendas da Filial 2
