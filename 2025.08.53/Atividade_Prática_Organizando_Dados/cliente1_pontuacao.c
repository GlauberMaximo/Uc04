...
int main(){
    // Declaração de um array de inteiros chamado 'pontuaçoes_clientes' com 5 elementos
    ...
    soma_pontuacoes = pontuacoes_clientes[0] + pontuacoes_clientes[1] + pontuacoes_clientes[2] + pontuacoes_clientes[3] + pontuacoes_clientes[4];
